...
@section('content')
    <div class="container mx-auto px-4 pt-16 ">
        <!-- Start movie-info -->
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row border-b border-gray-800 text-justify">
            <div class="flex-none">
                <img src="{{ $movie['poster_path'] }}" alt="poster"
                    class="hover:opacity-75 transition ease-in-out duration-150 w-64 lg:w-96 rounded-lg">
            </div>
            <div class="md:ml-24">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                src="https://www.youtube.com/embed/{{ $movie['videos'] }}" style="border:0;"
        ...
        <div class="movie-cast border-b border-gray-800">
            <div class="container mx-auto px-4 py-16">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 rounded-lg">
